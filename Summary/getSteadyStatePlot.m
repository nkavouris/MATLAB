function[SSindex]=getSteadyStatePlot(cook)
%temperature=cook.TempF; % Replace with your data file name
temperature=cook.TempF; % Replace with your data file name


% Define parameters
min_steady_duration = 200; % Minimum number of measurements for steady state
min_delta_temperature = 0.06; % Minimum temperature change for steady state (Fahrenheit)
filter_window = 180; % Moving average filter window size
steady_tolerance = 0.02; % Tolerance for steady state (Fahrenheit)
transparency = 0.5; % Transparency of steady state regions
